package com.mine.geometry_node.client.ui.editor.graph.properties.session;
...
/**
 * Exposes the active graph document through the shared properties target contract.
 */
public final class GraphSessionPropertiesTarget implements GraphPropertiesTarget, EditorContext.EditorListener {
    ...
    public GraphSessionPropertiesTarget(GraphSession session) {
        mSession = Objects.requireNonNull(session, "document");
    }
