...
public final class HostMaterialAnalyzer {
    private HostMaterialAnalyzer() {
    }

    public static HostMaterialProjection analyze(HostMaterialProfile profile,
        ...
        boolean labPbr = profile == HostMaterialProfile.HOST_NATIVE_LABPBR;
        ...
        return new HostMaterialProjection(!skinned, profile, selectedUv,
