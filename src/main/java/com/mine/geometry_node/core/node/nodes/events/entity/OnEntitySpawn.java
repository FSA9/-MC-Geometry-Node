...
public class OnEntitySpawn extends BaseEventNode {
    public static final String TYPE_ID = "on_entity_spawn";

    @Override
    public NodeDef getDefaultDefinition() {
        return NodeDef.builder(TYPE_ID, NodeType.EVENT, Component.translatable("geometry_node.node.on_entity_spawn"))
