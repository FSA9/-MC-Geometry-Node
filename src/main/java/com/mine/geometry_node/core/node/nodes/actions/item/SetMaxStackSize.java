...
public class SetMaxStackSize extends BaseNode {
    public static final String TYPE_ID = "set_max_stack_size";
    ...
    public NodeDef getDefaultDefinition() {
        return NodeDef.builder(TYPE_ID, NodeType.ACTION, Component.translatable("geometry_node.node." + TYPE_ID))
                ...
                .addRow(new PortRow(StandardPorts.INT.toInput(64), null, UIHint.INPUT, null, null))
                .build();
    }
    ...
    public ExecutionResult execute(ExecutionContext context) {
        ...
        if (stack != null && !stack.isEmpty() && value != null) {
            stack.set(DataComponents.MAX_STACK_SIZE, Math.max(1, Math.min(value, 99)));
