...
public class OnChunkLoad extends BaseEventNode {
    public static final String TYPE_ID = "on_chunk_load";
    @Override
    public NodeDef getDefaultDefinition() {
        return NodeDef.builder(TYPE_ID, NodeType.EVENT, Component.translatable("geometry_node.node.on_chunk_load"))
