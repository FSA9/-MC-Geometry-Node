...
public final class AcceptQuest extends BaseNode {
    public static final String TYPE_ID = "accept_quest";
    private static final String SUCCESS_PORT = "success";
    private static final String FAILURE_REASON_PORT = "failure_reason";

    @Override
    public NodeDef getDefaultDefinition() {
        return NodeDef.builder(TYPE_ID, NodeType.QUEST, Component.translatable("geometry_node.node.accept_quest"))
                ...
                .addRow(new PortRow(null, PortDef.create(FAILURE_REASON_PORT, "geometry_node.port.quest_condition_failure_text", PortType.STRING), UIHint.DEFAULT, null, null))
    ...
    public ExecutionResult execute(ExecutionContext context) {
        ...
        context.setNodeResult(FAILURE_REASON_PORT, result.message());
