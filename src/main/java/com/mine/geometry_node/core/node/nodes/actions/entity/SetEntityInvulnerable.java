...
public class SetEntityInvulnerable extends BaseNode {
    public static final String TYPE_ID = "set_entity_invulnerable";

    @Override
    public NodeDef getDefaultDefinition() {
        return NodeDef.builder(TYPE_ID, NodeType.ACTION, Component.translatable("geometry_node.node.set_entity_invulnerable"))
