...
public class SetEntityGlowing extends BaseNode {
    ...
    public ExecutionResult execute(ExecutionContext context) {
        ...
        Boolean glowing = getInput(context, StandardPorts.BOOL.getId(), Boolean.class);

        if (glowing != null && !entities.isEmpty()) {
            for (Entity entity : entities) {
                entity.setGlowingTag(glowing); // 1.21 的原生发光标记方法
            }
        }
