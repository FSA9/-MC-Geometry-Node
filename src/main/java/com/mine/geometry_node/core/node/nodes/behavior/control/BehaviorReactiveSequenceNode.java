...
public final class BehaviorReactiveSequenceNode extends BaseNode implements BehaviorExecutableNode {
    public static final String TYPE_ID = "geometry_node:behavior_reactive_sequence";
    ...
    private static NodeDef definition(NodeData instanceData) {
        return BehaviorCompositeDefinition.create(TYPE_ID,
                "geometry_node.node.behavior_reactive_sequence", instanceData);
    }

    @Override
    public BehaviorNodeExecutor behaviorExecutor() {
        return BehaviorControlExecutors.reactiveSequence();
    }
}
