...
public class SetEntityNoGravity extends BaseNode {
    public static final String TYPE_ID = "set_entity_no_gravity";

    @Override
    public NodeDef getDefaultDefinition() {
        return NodeDef.builder(TYPE_ID, NodeType.ACTION, Component.translatable("geometry_node.node.set_entity_no_gravity"))
