...
public class SnapshotValue extends BaseNode {
    ...
    public NodeDef getDefaultDefinition() {
        return NodeDef.builder(TYPE_ID, NodeType.MATH, Component.translatable("geometry_node.node.snapshot_value"))
                .addRow(new PortRow(StandardPorts.VALUE.toInput(), StandardPorts.VALUE.toOutput(), UIHint.DEFAULT, null, null))
                .build();
    }
    ...
    public Object compute(ExecutionContext context, String portName) {
        ...
        Object rawInput = getRawInput(context, StandardPorts.VALUE.getId());
