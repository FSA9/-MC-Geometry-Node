...
public class OnPlayerLeftClickBlock extends BaseEventNode {

    public static final String TYPE_ID = "on_player_left_click_block";

    @Override
    public NodeDef getDefaultDefinition() {
        return NodeDef.builder(TYPE_ID, NodeType.EVENT, Component.translatable("geometry_node.node.on_player_left_click_block"))
